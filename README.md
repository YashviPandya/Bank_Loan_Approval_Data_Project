...
- Loaded and explored the loan applicant dataset, profiled distributions across income, loan amount, credit history, employment status, and dependents
- Cleaned data: handled missing values with domain-informed decisions, standardised categorical variables, and removed duplicate applicant records
...
- Identified the variables with the strongest predictive signal for both approval likelihood and default risk
---
